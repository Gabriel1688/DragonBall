...
window.gtbExternal&&(a=window.gtbExternal.pageT()),null==a&&window.external&&(a=window.external.pageT),a&&(window.jstiming.pt=a)}catch(d){}})();})();
 ...
 var codesite_token = "ABZ6GAfH1a0xjqC2yFriAoTM8ZBSPgVxeQ:1421292965831";
 
 
 var CS_env = {"projectHomeUrl": "/p/googletest", "token": "ABZ6GAfH1a0xjqC2yFriAoTM8ZBSPgVxeQ:1421292965831", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "domainName": null, "profileUrl": "/u/116848778305603003776/", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "relativeBaseUrl": "", "assetHostPath": "http://www.gstatic.com/codesite/ph", "projectName": "googletest"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgoogletest%2Fsource%2Fbrowse%2Ftrunk%2Fsamples%2Fsample8_unittest.cc" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/googletest/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/googletest/source/browse/trunk/samples/">samples</a><span class="sp">/&nbsp;</span>sample8_unittest.cc</span>
 ...
 <a href="/p/googletest/source/browse/trunk/samples/sample8_unittest.cc?edit=1"
 ...
 <li><a href="/p/googletest/source/browse/trunk/samples/sample8_unittest.cc?r=482" title="Previous">&lsaquo;r482</a></li>
...
><td class="source">// This sample shows how to test code relying on some global flag variables.<br></td></tr
><tr
id=sl_svn704_33

 onmouseover="gutterOver(33)"

><td class="source">// Combine() helps with generating all possible combinations of such flags,<br></td></tr
><tr
id=sl_svn704_34

 onmouseover="gutterOver(34)"

><td class="source">// and each test is given one combination as a parameter.<br></td></tr
><tr
id=sl_svn704_35
...
><td class="source">// Use class definitions to test from this header.<br></td></tr
><tr
id=sl_svn704_37
...
><td class="source">#if GTEST_HAS_COMBINE<br></td></tr
><tr
id=sl_svn704_42
...
><td class="source">// Suppose we want to introduce a new, improved implementation of PrimeTable<br></td></tr
><tr
id=sl_svn704_44

 onmouseover="gutterOver(44)"

><td class="source">// which combines speed of PrecalcPrimeTable and versatility of<br></td></tr
><tr
id=sl_svn704_45

 onmouseover="gutterOver(45)"

><td class="source">// OnTheFlyPrimeTable (see prime_tables.h). Inside it instantiates both<br></td></tr
><tr
id=sl_svn704_46

 onmouseover="gutterOver(46)"

><td class="source">// PrecalcPrimeTable and OnTheFlyPrimeTable and uses the one that is more<br></td></tr
><tr
id=sl_svn704_47

 onmouseover="gutterOver(47)"

><td class="source">// appropriate under the circumstances. But in low memory conditions, it can be<br></td></tr
><tr
id=sl_svn704_48

 onmouseover="gutterOver(48)"

><td class="source">// told to instantiate without PrecalcPrimeTable instance at all and use only<br></td></tr
><tr
id=sl_svn704_49

 onmouseover="gutterOver(49)"

><td class="source">// OnTheFlyPrimeTable.<br></td></tr
><tr
id=sl_svn704_50

 onmouseover="gutterOver(50)"

><td class="source">class HybridPrimeTable : public PrimeTable {<br></td></tr
><tr
id=sl_svn704_51
...
><td class="source">  HybridPrimeTable(bool force_on_the_fly, int max_precalculated)<br></td></tr
><tr
id=sl_svn704_53

 onmouseover="gutterOver(53)"

><td class="source">      : on_the_fly_impl_(new OnTheFlyPrimeTable),<br></td></tr
><tr
id=sl_svn704_54

 onmouseover="gutterOver(54)"

><td class="source">        precalc_impl_(force_on_the_fly ? NULL :<br></td></tr
><tr
id=sl_svn704_55

 onmouseover="gutterOver(55)"

><td class="source">                          new PreCalculatedPrimeTable(max_precalculated)),<br></td></tr
><tr
id=sl_svn704_56

 onmouseover="gutterOver(56)"

><td class="source">        max_precalculated_(max_precalculated) {}<br></td></tr
><tr
id=sl_svn704_57

 onmouseover="gutterOver(57)"

><td class="source">  virtual ~HybridPrimeTable() {<br></td></tr
><tr
id=sl_svn704_58

 onmouseover="gutterOver(58)"

><td class="source">    delete on_the_fly_impl_;<br></td></tr
><tr
id=sl_svn704_59

 onmouseover="gutterOver(59)"

><td class="source">    delete precalc_impl_;<br></td></tr
><tr
id=sl_svn704_60
...
><td class="source">  virtual bool IsPrime(int n) const {<br></td></tr
><tr
id=sl_svn704_63

 onmouseover="gutterOver(63)"

><td class="source">    if (precalc_impl_ != NULL &amp;&amp; n &lt; max_precalculated_)<br></td></tr
><tr
id=sl_svn704_64

 onmouseover="gutterOver(64)"

><td class="source">      return precalc_impl_-&gt;IsPrime(n);<br></td></tr
><tr
id=sl_svn704_65
...
><td class="source">      return on_the_fly_impl_-&gt;IsPrime(n);<br></td></tr
><tr
id=sl_svn704_67
...
><td class="source">  virtual int GetNextPrime(int p) const {<br></td></tr
><tr
id=sl_svn704_70

 onmouseover="gutterOver(70)"

><td class="source">    int next_prime = -1;<br></td></tr
><tr
id=sl_svn704_71

 onmouseover="gutterOver(71)"

><td class="source">    if (precalc_impl_ != NULL &amp;&amp; p &lt; max_precalculated_)<br></td></tr
><tr
id=sl_svn704_72

 onmouseover="gutterOver(72)"

><td class="source">      next_prime = precalc_impl_-&gt;GetNextPrime(p);<br></td></tr
><tr
id=sl_svn704_73
...
><td class="source">    return next_prime != -1 ? next_prime : on_the_fly_impl_-&gt;GetNextPrime(p);<br></td></tr
><tr
id=sl_svn704_75
...
><td class="source">  OnTheFlyPrimeTable* on_the_fly_impl_;<br></td></tr
><tr
id=sl_svn704_79

 onmouseover="gutterOver(79)"

><td class="source">  PreCalculatedPrimeTable* precalc_impl_;<br></td></tr
><tr
id=sl_svn704_80

 onmouseover="gutterOver(80)"

><td class="source">  int max_precalculated_;<br></td></tr
><tr
id=sl_svn704_81
...
><td class="source">using ::testing::Bool;<br></td></tr
><tr
id=sl_svn704_85
...
><td class="source">using ::testing::Combine;<br></td></tr
><tr
id=sl_svn704_87
...
><td class="source">// To test all code paths for HybridPrimeTable we must test it with numbers<br></td></tr
><tr
id=sl_svn704_89

 onmouseover="gutterOver(89)"

><td class="source">// both within and outside PreCalculatedPrimeTable&#39;s capacity and also with<br></td></tr
><tr
id=sl_svn704_90

 onmouseover="gutterOver(90)"

><td class="source">// PreCalculatedPrimeTable disabled. We do this by defining fixture which will<br></td></tr
><tr
id=sl_svn704_91

 onmouseover="gutterOver(91)"

><td class="source">// accept different combinations of parameters for instantiating a<br></td></tr
><tr
id=sl_svn704_92

 onmouseover="gutterOver(92)"

><td class="source">// HybridPrimeTable instance.<br></td></tr
><tr
id=sl_svn704_93

 onmouseover="gutterOver(93)"

><td class="source">class PrimeTableTest : public TestWithParam&lt; ::testing::tuple&lt;bool, int&gt; &gt; {<br></td></tr
><tr
id=sl_svn704_94
...
><td class="source">    // This can be written as<br></td></tr
><tr
id=sl_svn704_97
...
><td class="source">    // bool force_on_the_fly;<br></td></tr
><tr
id=sl_svn704_99

 onmouseover="gutterOver(99)"

><td class="source">    // int max_precalculated;<br></td></tr
><tr
id=sl_svn704_100

 onmouseover="gutterOver(100)"

><td class="source">    // tie(force_on_the_fly, max_precalculated) = GetParam();<br></td></tr
><tr
id=sl_svn704_101
...
><td class="source">    // once the Google C++ Style Guide allows use of ::std::tr1::tie.<br></td></tr
><tr
id=sl_svn704_103
...
><td class="source">    bool force_on_the_fly = ::testing::get&lt;0&gt;(GetParam());<br></td></tr
><tr
id=sl_svn704_105

 onmouseover="gutterOver(105)"

><td class="source">    int max_precalculated = ::testing::get&lt;1&gt;(GetParam());<br></td></tr
><tr
id=sl_svn704_106

 onmouseover="gutterOver(106)"

><td class="source">    table_ = new HybridPrimeTable(force_on_the_fly, max_precalculated);<br></td></tr
><tr
id=sl_svn704_107
...
><td class="source">  HybridPrimeTable* table_;<br></td></tr
><tr
id=sl_svn704_113
...
><td class="source">  // Inside the test body, you can refer to the test parameter by GetParam().<br></td></tr
><tr
id=sl_svn704_117

 onmouseover="gutterOver(117)"

><td class="source">  // In this case, the test parameter is a PrimeTable interface pointer which<br></td></tr
><tr
id=sl_svn704_118

 onmouseover="gutterOver(118)"

><td class="source">  // we can use directly.<br></td></tr
><tr
id=sl_svn704_119

 onmouseover="gutterOver(119)"

><td class="source">  // Please note that you can also save it in the fixture&#39;s SetUp() method<br></td></tr
><tr
id=sl_svn704_120

 onmouseover="gutterOver(120)"

><td class="source">  // or constructor and use saved copy in the tests.<br></td></tr
><tr
id=sl_svn704_121
...
><td class="source">// Here, we instantiate our tests with a list of parameters. We must combine<br></td></tr
><tr
id=sl_svn704_154

 onmouseover="gutterOver(154)"

><td class="source">// all variations of the boolean flag suppressing PrecalcPrimeTable and some<br></td></tr
><tr
id=sl_svn704_155

 onmouseover="gutterOver(155)"

><td class="source">// meaningful values for tests. We choose a small value (1), and a value that<br></td></tr
><tr
id=sl_svn704_156

 onmouseover="gutterOver(156)"

><td class="source">// will put some of the tested numbers beyond the capability of the<br></td></tr
><tr
id=sl_svn704_157

 onmouseover="gutterOver(157)"

><td class="source">// PrecalcPrimeTable instance and some inside it (10). Combine will produce all<br></td></tr
><tr
id=sl_svn704_158

 onmouseover="gutterOver(158)"

><td class="source">// possible combinations.<br></td></tr
><tr
id=sl_svn704_159

 onmouseover="gutterOver(159)"

><td class="source">INSTANTIATE_TEST_CASE_P(MeaningfulTestParameters,<br></td></tr
><tr
id=sl_svn704_160
...
><td class="source">                        Combine(Bool(), Values(1, 10)));<br></td></tr
><tr
id=sl_svn704_162
...
><td class="source">// Google Test may not support Combine() with some compilers. If we<br></td></tr
><tr
id=sl_svn704_166

 onmouseover="gutterOver(166)"

><td class="source">// use conditional compilation to compile out all code referring to<br></td></tr
><tr
id=sl_svn704_167

 onmouseover="gutterOver(167)"

><td class="source">// the gtest_main library, MSVC linker will not link that library at<br></td></tr
><tr
id=sl_svn704_168

 onmouseover="gutterOver(168)"

><td class="source">// all and consequently complain about missing entry point defined in<br></td></tr
><tr
id=sl_svn704_169

 onmouseover="gutterOver(169)"

><td class="source">// that library (fatal error LNK1561: entry point must be<br></td></tr
><tr
id=sl_svn704_170

 onmouseover="gutterOver(170)"

><td class="source">// defined). This dummy test keeps gtest_main linked in.<br></td></tr
><tr
id=sl_svn704_171

 onmouseover="gutterOver(171)"

><td class="source">TEST(DummyTest, CombineIsNotSupportedOnThisPlatform) {}<br></td></tr
><tr
id=sl_svn704_172
...
><td class="source">#endif  // GTEST_HAS_COMBINE<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/googletest/source/detail?spec=svn704&amp;r=682">r682</a>
 by ko...@google.com
 on Apr 2, 2014
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=682&amp;format=side&amp;path=/trunk/samples/sample8_unittest.cc&amp;old_path=/trunk/samples/sample8_unittest.cc&amp;old=482">Diff</a>
 </div>
 <pre>Export tuple and friends in the ::testing
namespace.
</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/googletest/source/detail?r=682&spec=svn704';
 var publish_url = '/p/googletest/source/detail?r=682&spec=svn704#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/include/gtest/internal/gtest-param-util-generated.h');
 changed_urls.push('/p/googletest/source/browse/trunk/include/gtest/internal/gtest-param-util-generated.h?r\x3d682\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/include/gtest/internal/gtest-param-util-generated.h.pump');
 changed_urls.push('/p/googletest/source/browse/trunk/include/gtest/internal/gtest-param-util-generated.h.pump?r\x3d682\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/include/gtest/internal/gtest-port.h');
 changed_urls.push('/p/googletest/source/browse/trunk/include/gtest/internal/gtest-port.h?r\x3d682\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/samples/sample8_unittest.cc');
 changed_urls.push('/p/googletest/source/browse/trunk/samples/sample8_unittest.cc?r\x3d682\x26spec\x3dsvn704');
 
 var selected_path = '/trunk/samples/sample8_unittest.cc';
 
 
 changed_paths.push('/trunk/test/gtest-param-test_test.cc');
 changed_urls.push('/p/googletest/source/browse/trunk/test/gtest-param-test_test.cc?r\x3d682\x26spec\x3dsvn704');
 ...
 <option value="/p/googletest/source/browse/trunk/include/gtest/internal/gtest-param-util-generated.h?r=682&amp;spec=svn704"
 
 >...nal/gtest-param-util-generated.h</option>
 
 <option value="/p/googletest/source/browse/trunk/include/gtest/internal/gtest-param-util-generated.h.pump?r=682&amp;spec=svn704"
 
 >...test-param-util-generated.h.pump</option>
 
 <option value="/p/googletest/source/browse/trunk/include/gtest/internal/gtest-port.h?r=682&amp;spec=svn704"
 
 >...lude/gtest/internal/gtest-port.h</option>
 
 <option value="/p/googletest/source/browse/trunk/samples/sample8_unittest.cc?r=682&amp;spec=svn704"
 selected="selected"
 >/trunk/samples/sample8_unittest.cc</option>
 
 <option value="/p/googletest/source/browse/trunk/test/gtest-param-test_test.cc?r=682&amp;spec=svn704"
 ...
 <a class="ifOpened" href="/p/googletest/source/detail?r=682&spec=svn704#publish">Publish your comments</a>
 ...
 by zhanyong.wan
 on Sep 13, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=482&amp;format=side&amp;path=/trunk/samples/sample8_unittest.cc&amp;old_path=/trunk/samples/sample8_unittest.cc&amp;old=386">Diff</a>
 <br>
...
instead of system headers.
 ...
 by zhanyong.wan
 on Mar 4, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=386&amp;format=side&amp;path=/trunk/samples/sample8_unittest.cc&amp;old_path=/trunk/samples/sample8_unittest.cc&amp;old=195">Diff</a>
 <br>
...
...</pre>
 ...
 by zhanyong.wan
 on Feb 23, 2009
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=195&amp;format=side&amp;path=/trunk/samples/sample8_unittest.cc&amp;old_path=/trunk/samples/sample8_unittest.cc&amp;old=120">Diff</a>
 <br>
 ...
 <a href="/p/googletest/source/list?path=/trunk/samples/sample8_unittest.cc&start=682">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//googletest.googlecode.com/svn/trunk/samples/sample8_unittest.cc">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn704': '/trunk/samples/sample8_unittest.cc'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/googletest", "token": "ABZ6GAfH1a0xjqC2yFriAoTM8ZBSPgVxeQ:1421292965831", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "domainName": null, "profileUrl": "/u/116848778305603003776/", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "relativeBaseUrl": "", "assetHostPath": "http://www.gstatic.com/codesite/ph", "projectName": "googletest"}, '', 'svn704', paths,
