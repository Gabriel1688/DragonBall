...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgoogletest%2Fsource%2Fbrowse%2Ftrunk%2Fsamples%2Fsample2.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/googletest/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/googletest/source/browse/trunk/samples/">samples</a><span class="sp">/&nbsp;</span>sample2.h</span>
 ...
 <a href="/p/googletest/source/browse/trunk/samples/sample2.h?edit=1"
 ...
 <li><a href="/p/googletest/source/browse/trunk/samples/sample2.h?r=383" title="Previous">&lsaquo;r383</a></li>
...
><td class="source">#ifndef GTEST_SAMPLES_SAMPLE2_H_<br></td></tr
><tr
id=sl_svn704_35

 onmouseover="gutterOver(35)"

><td class="source">#define GTEST_SAMPLES_SAMPLE2_H_<br></td></tr
><tr
id=sl_svn704_36
...
><td class="source">// A simple string class.<br></td></tr
><tr
id=sl_svn704_41

 onmouseover="gutterOver(41)"

><td class="source">class MyString {<br></td></tr
><tr
id=sl_svn704_42
...
><td class="source">  const char* c_string_;<br></td></tr
><tr
id=sl_svn704_44

 onmouseover="gutterOver(44)"

><td class="source">  const MyString&amp; operator=(const MyString&amp; rhs);<br></td></tr
><tr
id=sl_svn704_45
...
><td class="source">  static const char* CloneCString(const char* a_c_string);<br></td></tr
><tr
id=sl_svn704_49
...
><td class="source">  // C&#39;tors<br></td></tr
><tr
id=sl_svn704_53
...
><td class="source">  // The default c&#39;tor constructs a NULL string.<br></td></tr
><tr
id=sl_svn704_55

 onmouseover="gutterOver(55)"

><td class="source">  MyString() : c_string_(NULL) {}<br></td></tr
><tr
id=sl_svn704_56
...
><td class="source">  // Constructs a MyString by cloning a 0-terminated C string.<br></td></tr
><tr
id=sl_svn704_58

 onmouseover="gutterOver(58)"

><td class="source">  explicit MyString(const char* a_c_string) : c_string_(NULL) {<br></td></tr
><tr
id=sl_svn704_59

 onmouseover="gutterOver(59)"

><td class="source">    Set(a_c_string);<br></td></tr
><tr
id=sl_svn704_60
...
><td class="source">  // Copy c&#39;tor<br></td></tr
><tr
id=sl_svn704_63

 onmouseover="gutterOver(63)"

><td class="source">  MyString(const MyString&amp; string) : c_string_(NULL) {<br></td></tr
><tr
id=sl_svn704_64

 onmouseover="gutterOver(64)"

><td class="source">    Set(string.c_string_);<br></td></tr
><tr
id=sl_svn704_65
...
><td class="source">  // D&#39;tor.  MyString is intended to be a final class, so the d&#39;tor<br></td></tr
><tr
id=sl_svn704_70

 onmouseover="gutterOver(70)"

><td class="source">  // doesn&#39;t need to be virtual.<br></td></tr
><tr
id=sl_svn704_71

 onmouseover="gutterOver(71)"

><td class="source">  ~MyString() { delete[] c_string_; }<br></td></tr
><tr
id=sl_svn704_72
...
><td class="source">  // Gets the 0-terminated C string this MyString object represents.<br></td></tr
><tr
id=sl_svn704_74

 onmouseover="gutterOver(74)"

><td class="source">  const char* c_string() const { return c_string_; }<br></td></tr
><tr
id=sl_svn704_75
...
><td class="source">  size_t Length() const {<br></td></tr
><tr
id=sl_svn704_77

 onmouseover="gutterOver(77)"

><td class="source">    return c_string_ == NULL ? 0 : strlen(c_string_);<br></td></tr
><tr
id=sl_svn704_78
...
><td class="source">  // Sets the 0-terminated C string this MyString object represents.<br></td></tr
><tr
id=sl_svn704_81

 onmouseover="gutterOver(81)"

><td class="source">  void Set(const char* c_string);<br></td></tr
><tr
id=sl_svn704_82
...
><td class="source">#endif  // GTEST_SAMPLES_SAMPLE2_H_<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by vladlosev
 on Nov 4, 2011
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=607&amp;format=side&amp;path=/trunk/samples/sample2.h&amp;old_path=/trunk/samples/sample2.h&amp;old=383">Diff</a>
 </div>
...
Style Guide (by Greg Miller).</pre>
 ...
 var selected_path = '/trunk/samples/sample2.h';
 ...
 by vladlosev
 on Feb 27, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=383&amp;format=side&amp;path=/trunk/samples/sample2.h&amp;old_path=/trunk/samples/sample2.h&amp;old=40">Diff</a>
 <br>
...
-Wshadow -Werror.</pre>
 ...
 by shiqian
 on Jul 3, 2008
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=40&amp;format=side&amp;path=/trunk/samples/sample2.h&amp;old_path=/trunk/samples/sample2.h&amp;old=">Diff</a>
 <br>
 ...
 <a href="/p/googletest/source/list?path=/trunk/samples/sample2.h&start=607">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//googletest.googlecode.com/svn/trunk/samples/sample2.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn704': '/trunk/samples/sample2.h'}
 codereviews = CR_controller.setup(
 {"projectName": "googletest", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "projectHomeUrl": "/p/googletest", "profileUrl": "/u/116848778305603003776/", "relativeBaseUrl": "", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "token": "ABZ6GAesdFRh6fWWtSPgvLT_MztA-50H8w:1421292901196", "domainName": null, "assetHostPath": "http://www.gstatic.com/codesite/ph"}, '', 'svn704', paths,
