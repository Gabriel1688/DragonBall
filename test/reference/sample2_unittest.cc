...
<head>
 ...
 var codesite_token = "ABZ6GAcjYoKjYNHngStQ8voLvW4SeqMbsw:1421292906576";
 
 
 var CS_env = {"token": "ABZ6GAcjYoKjYNHngStQ8voLvW4SeqMbsw:1421292906576", "profileUrl": "/u/116848778305603003776/", "projectName": "googletest", "assetHostPath": "http://www.gstatic.com/codesite/ph", "domainName": null, "projectHomeUrl": "/p/googletest", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "relativeBaseUrl": ""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgoogletest%2Fsource%2Fbrowse%2Ftrunk%2Fsamples%2Fsample2_unittest.cc" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/googletest/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/googletest/source/browse/trunk/samples/">samples</a><span class="sp">/&nbsp;</span>sample2_unittest.cc</span>
 ...
 <a href="/p/googletest/source/browse/trunk/samples/sample2_unittest.cc?edit=1"
 ...
 <li><a href="/p/googletest/source/browse/trunk/samples/sample2_unittest.cc?r=482" title="Previous">&lsaquo;r482</a></li>
...
><td class="source">// This sample shows how to write a more complex unit test for a class<br></td></tr
><tr
id=sl_svn704_36

 onmouseover="gutterOver(36)"

><td class="source">// that has multiple member functions.<br></td></tr
><tr
id=sl_svn704_37
...
><td class="source">// Usually, it&#39;s a good idea to have one test for each method in your<br></td></tr
><tr
id=sl_svn704_39

 onmouseover="gutterOver(39)"

><td class="source">// class.  You don&#39;t have to do that exactly, but it helps to keep<br></td></tr
><tr
id=sl_svn704_40

 onmouseover="gutterOver(40)"

><td class="source">// your tests organized.  You may also throw in additional tests as<br></td></tr
><tr
id=sl_svn704_41

 onmouseover="gutterOver(41)"

><td class="source">// needed.<br></td></tr
><tr
id=sl_svn704_42
...
><td class="source">#include &quot;sample2.h&quot;<br></td></tr
><tr
id=sl_svn704_44
...
><td class="source">// In this example, we test the MyString class (a simple string).<br></td></tr
><tr
id=sl_svn704_47
...
><td class="source">TEST(MyString, DefaultConstructor) {<br></td></tr
><tr
id=sl_svn704_50

 onmouseover="gutterOver(50)"

><td class="source">  const MyString s;<br></td></tr
><tr
id=sl_svn704_51
...
><td class="source">  // Asserts that s.c_string() returns NULL.<br></td></tr
><tr
id=sl_svn704_53
...
><td class="source">  // If we write NULL instead of<br></td></tr
><tr
id=sl_svn704_57
...
><td class="source">  //   static_cast&lt;const char *&gt;(NULL)<br></td></tr
><tr
id=sl_svn704_59
...
><td class="source">  // in this assertion, it will generate a warning on gcc 3.4.  The<br></td></tr
><tr
id=sl_svn704_61

 onmouseover="gutterOver(61)"

><td class="source">  // reason is that EXPECT_EQ needs to know the types of its<br></td></tr
><tr
id=sl_svn704_62

 onmouseover="gutterOver(62)"

><td class="source">  // arguments in order to print them when it fails.  Since NULL is<br></td></tr
><tr
id=sl_svn704_63

 onmouseover="gutterOver(63)"

><td class="source">  // #defined as 0, the compiler will use the formatter function for<br></td></tr
><tr
id=sl_svn704_64

 onmouseover="gutterOver(64)"

><td class="source">  // int to print it.  However, gcc thinks that NULL should be used as<br></td></tr
><tr
id=sl_svn704_65

 onmouseover="gutterOver(65)"

><td class="source">  // a pointer, not an int, and therefore complains.<br></td></tr
><tr
id=sl_svn704_66
...
><td class="source">  // The root of the problem is C++&#39;s lack of distinction between the<br></td></tr
><tr
id=sl_svn704_68

 onmouseover="gutterOver(68)"

><td class="source">  // integer number 0 and the null pointer constant.  Unfortunately,<br></td></tr
><tr
id=sl_svn704_69

 onmouseover="gutterOver(69)"

><td class="source">  // we have to live with this fact.<br></td></tr
><tr
id=sl_svn704_70
...
><td class="source">  EXPECT_STREQ(NULL, s.c_string());<br></td></tr
><tr
id=sl_svn704_73
...
><td class="source">  EXPECT_EQ(0u, s.Length());<br></td></tr
><tr
id=sl_svn704_75
...
><td class="source">const char kHelloString[] = &quot;Hello, world!&quot;;<br></td></tr
><tr
id=sl_svn704_78
...
><td class="source">// Tests the c&#39;tor that accepts a C string.<br></td></tr
><tr
id=sl_svn704_80

 onmouseover="gutterOver(80)"

><td class="source">TEST(MyString, ConstructorFromCString) {<br></td></tr
><tr
id=sl_svn704_81

 onmouseover="gutterOver(81)"

><td class="source">  const MyString s(kHelloString);<br></td></tr
><tr
id=sl_svn704_82

 onmouseover="gutterOver(82)"

><td class="source">  EXPECT_EQ(0, strcmp(s.c_string(), kHelloString));<br></td></tr
><tr
id=sl_svn704_83

 onmouseover="gutterOver(83)"

><td class="source">  EXPECT_EQ(sizeof(kHelloString)/sizeof(kHelloString[0]) - 1,<br></td></tr
><tr
id=sl_svn704_84

 onmouseover="gutterOver(84)"

><td class="source">            s.Length());<br></td></tr
><tr
id=sl_svn704_85
...
><td class="source">// Tests the copy c&#39;tor.<br></td></tr
><tr
id=sl_svn704_88

 onmouseover="gutterOver(88)"

><td class="source">TEST(MyString, CopyConstructor) {<br></td></tr
><tr
id=sl_svn704_89

 onmouseover="gutterOver(89)"

><td class="source">  const MyString s1(kHelloString);<br></td></tr
><tr
id=sl_svn704_90

 onmouseover="gutterOver(90)"

><td class="source">  const MyString s2 = s1;<br></td></tr
><tr
id=sl_svn704_91

 onmouseover="gutterOver(91)"

><td class="source">  EXPECT_EQ(0, strcmp(s2.c_string(), kHelloString));<br></td></tr
><tr
id=sl_svn704_92
...
><td class="source">// Tests the Set method.<br></td></tr
><tr
id=sl_svn704_95

 onmouseover="gutterOver(95)"

><td class="source">TEST(MyString, Set) {<br></td></tr
><tr
id=sl_svn704_96

 onmouseover="gutterOver(96)"

><td class="source">  MyString s;<br></td></tr
><tr
id=sl_svn704_97
...
><td class="source">  s.Set(kHelloString);<br></td></tr
><tr
id=sl_svn704_99
...
><td class="source">  // Set should work when the input pointer is the same as the one<br></td></tr
><tr
id=sl_svn704_102

 onmouseover="gutterOver(102)"

><td class="source">  // already in the MyString object.<br></td></tr
><tr
id=sl_svn704_103

 onmouseover="gutterOver(103)"

><td class="source">  s.Set(s.c_string());<br></td></tr
><tr
id=sl_svn704_104
...
><td class="source">  // Can we set the MyString to NULL?<br></td></tr
><tr
id=sl_svn704_107

 onmouseover="gutterOver(107)"

><td class="source">  s.Set(NULL);<br></td></tr
><tr
id=sl_svn704_108
...
<script type="text/javascript">
 ...
 by vladlosev
 on Nov 4, 2011
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=607&amp;format=side&amp;path=/trunk/samples/sample2_unittest.cc&amp;old_path=/trunk/samples/sample2_unittest.cc&amp;old=482">Diff</a>
 </div>
...
Style Guide (by Greg Miller).</pre>
 ...
 var selected_path = '/trunk/samples/sample2_unittest.cc';
 ...
 by zhanyong.wan
 on Sep 13, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=482&amp;format=side&amp;path=/trunk/samples/sample2_unittest.cc&amp;old_path=/trunk/samples/sample2_unittest.cc&amp;old=383">Diff</a>
 <br>
...
instead of system headers.
 ...
 by vladlosev
 on Feb 27, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=383&amp;format=side&amp;path=/trunk/samples/sample2_unittest.cc&amp;old_path=/trunk/samples/sample2_unittest.cc&amp;old=40">Diff</a>
 <br>
...
-Wshadow -Werror.</pre>
 ...
 by shiqian
 on Jul 3, 2008
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=40&amp;format=side&amp;path=/trunk/samples/sample2_unittest.cc&amp;old_path=/trunk/samples/sample2_unittest.cc&amp;old=">Diff</a>
 <br>
 ...
 <a href="/p/googletest/source/list?path=/trunk/samples/sample2_unittest.cc&start=607">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//googletest.googlecode.com/svn/trunk/samples/sample2_unittest.cc">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn704': '/trunk/samples/sample2_unittest.cc'}
 codereviews = CR_controller.setup(
 {"token": "ABZ6GAcjYoKjYNHngStQ8voLvW4SeqMbsw:1421292906576", "profileUrl": "/u/116848778305603003776/", "projectName": "googletest", "assetHostPath": "http://www.gstatic.com/codesite/ph", "domainName": null, "projectHomeUrl": "/p/googletest", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "relativeBaseUrl": ""}, '', 'svn704', paths,
