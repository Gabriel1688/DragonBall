...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgoogletest%2Fsource%2Fbrowse%2Ftrunk%2Fsamples%2Fsample2.cc" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/googletest/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/googletest/source/browse/trunk/samples/">samples</a><span class="sp">/&nbsp;</span>sample2.cc</span>
 ...
 <a href="/p/googletest/source/browse/trunk/samples/sample2.cc?edit=1"
 ...
 <li><a href="/p/googletest/source/browse/trunk/samples/sample2.cc?r=120" title="Previous">&lsaquo;r120</a></li>
...
><td class="source">// Clones a 0-terminated C string, allocating memory using new.<br></td></tr
><tr
id=sl_svn704_39

 onmouseover="gutterOver(39)"

><td class="source">const char* MyString::CloneCString(const char* a_c_string) {<br></td></tr
><tr
id=sl_svn704_40

 onmouseover="gutterOver(40)"

><td class="source">  if (a_c_string == NULL) return NULL;<br></td></tr
><tr
id=sl_svn704_41
...
><td class="source">  const size_t len = strlen(a_c_string);<br></td></tr
><tr
id=sl_svn704_43

 onmouseover="gutterOver(43)"

><td class="source">  char* const clone = new char[ len + 1 ];<br></td></tr
><tr
id=sl_svn704_44

 onmouseover="gutterOver(44)"

><td class="source">  memcpy(clone, a_c_string, len + 1);<br></td></tr
><tr
id=sl_svn704_45
...
><td class="source">  return clone;<br></td></tr
><tr
id=sl_svn704_47
...
><td class="source">// Sets the 0-terminated C string this MyString object<br></td></tr
><tr
id=sl_svn704_50

 onmouseover="gutterOver(50)"

><td class="source">// represents.<br></td></tr
><tr
id=sl_svn704_51

 onmouseover="gutterOver(51)"

><td class="source">void MyString::Set(const char* a_c_string) {<br></td></tr
><tr
id=sl_svn704_52

 onmouseover="gutterOver(52)"

><td class="source">  // Makes sure this works when c_string == c_string_<br></td></tr
><tr
id=sl_svn704_53

 onmouseover="gutterOver(53)"

><td class="source">  const char* const temp = MyString::CloneCString(a_c_string);<br></td></tr
><tr
id=sl_svn704_54

 onmouseover="gutterOver(54)"

><td class="source">  delete[] c_string_;<br></td></tr
><tr
id=sl_svn704_55

 onmouseover="gutterOver(55)"

><td class="source">  c_string_ = temp;<br></td></tr
><tr
id=sl_svn704_56
...
<script type="text/javascript">
 ...
 by vladlosev
 on Feb 27, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=383&amp;format=side&amp;path=/trunk/samples/sample2.cc&amp;old_path=/trunk/samples/sample2.cc&amp;old=120">Diff</a>
 </div>
 <pre>Makes all samples compile with -Wall
-Wshadow -Werror.</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/googletest/source/detail?r=383&spec=svn704';
 var publish_url = '/p/googletest/source/detail?r=383&spec=svn704#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/CMakeLists.txt');
 changed_urls.push('/p/googletest/source/browse/trunk/CMakeLists.txt?r\x3d383\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/samples/sample2.cc');
 changed_urls.push('/p/googletest/source/browse/trunk/samples/sample2.cc?r\x3d383\x26spec\x3dsvn704');
 
 var selected_path = '/trunk/samples/sample2.cc';
 
 
 changed_paths.push('/trunk/samples/sample2.h');
 changed_urls.push('/p/googletest/source/browse/trunk/samples/sample2.h?r\x3d383\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/samples/sample2_unittest.cc');
 changed_urls.push('/p/googletest/source/browse/trunk/samples/sample2_unittest.cc?r\x3d383\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/samples/sample3-inl.h');
 changed_urls.push('/p/googletest/source/browse/trunk/samples/sample3-inl.h?r\x3d383\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/samples/sample3_unittest.cc');
 changed_urls.push('/p/googletest/source/browse/trunk/samples/sample3_unittest.cc?r\x3d383\x26spec\x3dsvn704');
 
 
 changed_paths.push('/trunk/samples/sample5_unittest.cc');
 changed_urls.push('/p/googletest/source/browse/trunk/samples/sample5_unittest.cc?r\x3d383\x26spec\x3dsvn704');
 ...
 <option value="/p/googletest/source/browse/trunk/CMakeLists.txt?r=383&amp;spec=svn704"
 
 >/trunk/CMakeLists.txt</option>
 
 <option value="/p/googletest/source/browse/trunk/samples/sample2.cc?r=383&amp;spec=svn704"
 selected="selected"
 >/trunk/samples/sample2.cc</option>
 
 <option value="/p/googletest/source/browse/trunk/samples/sample2.h?r=383&amp;spec=svn704"
 
 >/trunk/samples/sample2.h</option>
 
 <option value="/p/googletest/source/browse/trunk/samples/sample2_unittest.cc?r=383&amp;spec=svn704"
 
 >/trunk/samples/sample2_unittest.cc</option>
 
 <option value="/p/googletest/source/browse/trunk/samples/sample3-inl.h?r=383&amp;spec=svn704"
 
 >/trunk/samples/sample3-inl.h</option>
 
 <option value="/p/googletest/source/browse/trunk/samples/sample3_unittest.cc?r=383&amp;spec=svn704"
 
 >/trunk/samples/sample3_unittest.cc</option>
 
 <option value="/p/googletest/source/browse/trunk/samples/sample5_unittest.cc?r=383&amp;spec=svn704"
 ...
 <a class="ifOpened" href="/p/googletest/source/detail?r=383&spec=svn704#publish">Publish your comments</a>
 ...
 by vladlosev
 on Nov 19, 2008
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=120&amp;format=side&amp;path=/trunk/samples/sample2.cc&amp;old_path=/trunk/samples/sample2.cc&amp;old=40">Diff</a>
 <br>
...
bugfixes</pre>
 ...
 by shiqian
 on Jul 3, 2008
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=40&amp;format=side&amp;path=/trunk/samples/sample2.cc&amp;old_path=/trunk/samples/sample2.cc&amp;old=">Diff</a>
 <br>
 ...
 <a href="/p/googletest/source/list?path=/trunk/samples/sample2.cc&start=383">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//googletest.googlecode.com/svn/trunk/samples/sample2.cc">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn704': '/trunk/samples/sample2.cc'}
 codereviews = CR_controller.setup(
 {"token": "ABZ6GAc-GNJof-vNE1jVGz2HQH4gUg-8EA:1421292895496", "profileUrl": "/u/116848778305603003776/", "projectName": "googletest", "assetHostPath": "http://www.gstatic.com/codesite/ph", "domainName": null, "projectHomeUrl": "/p/googletest", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "relativeBaseUrl": ""}, '', 'svn704', paths,
