...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgoogletest%2Fsource%2Fbrowse%2Ftrunk%2Fsamples%2Fsample1_unittest.cc" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/googletest/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/googletest/source/browse/trunk/samples/">samples</a><span class="sp">/&nbsp;</span>sample1_unittest.cc</span>
 ...
 <a href="/p/googletest/source/browse/trunk/samples/sample1_unittest.cc?edit=1"
 ...
 <li><a href="/p/googletest/source/browse/trunk/samples/sample1_unittest.cc?r=482" title="Previous">&lsaquo;r482</a></li>
...
><td class="source">// This sample shows how to write a simple unit test for a function,<br></td></tr
><tr
id=sl_svn704_36

 onmouseover="gutterOver(36)"

><td class="source">// using Google C++ testing framework.<br></td></tr
><tr
id=sl_svn704_37
...
><td class="source">// Writing a unit test using Google C++ testing framework is easy as 1-2-3:<br></td></tr
><tr
id=sl_svn704_39
...
><td class="source">// Step 1. Include necessary header files such that the stuff your<br></td></tr
><tr
id=sl_svn704_42

 onmouseover="gutterOver(42)"

><td class="source">// test logic needs is declared.<br></td></tr
><tr
id=sl_svn704_43
...
><td class="source">// Don&#39;t forget gtest.h, which declares the testing framework.<br></td></tr
><tr
id=sl_svn704_45
...
><td class="source">// Step 2. Use the TEST macro to define your tests.<br></td></tr
><tr
id=sl_svn704_52
...
><td class="source">// TEST has two parameters: the test case name and the test name.<br></td></tr
><tr
id=sl_svn704_54

 onmouseover="gutterOver(54)"

><td class="source">// After using the macro, you should define your test logic between a<br></td></tr
><tr
id=sl_svn704_55

 onmouseover="gutterOver(55)"

><td class="source">// pair of braces.  You can use a bunch of macros to indicate the<br></td></tr
><tr
id=sl_svn704_56

 onmouseover="gutterOver(56)"

><td class="source">// success or failure of a test.  EXPECT_TRUE and EXPECT_EQ are<br></td></tr
><tr
id=sl_svn704_57

 onmouseover="gutterOver(57)"

><td class="source">// examples of such macros.  For a complete list, see gtest.h.<br></td></tr
><tr
id=sl_svn704_58
...
><td class="source">// In Google Test, tests are grouped into test cases.  This is how we<br></td></tr
><tr
id=sl_svn704_62

 onmouseover="gutterOver(62)"

><td class="source">// keep test code organized.  You should put logically related tests<br></td></tr
><tr
id=sl_svn704_63

 onmouseover="gutterOver(63)"

><td class="source">// into the same test case.<br></td></tr
><tr
id=sl_svn704_64
...
><td class="source">// The test case name and the test name should both be valid C++<br></td></tr
><tr
id=sl_svn704_66

 onmouseover="gutterOver(66)"

><td class="source">// identifiers.  And you should not use underscore (_) in the names.<br></td></tr
><tr
id=sl_svn704_67
...
><td class="source">// Google Test guarantees that each test you define is run exactly<br></td></tr
><tr
id=sl_svn704_69

 onmouseover="gutterOver(69)"

><td class="source">// once, but it makes no guarantee on the order the tests are<br></td></tr
><tr
id=sl_svn704_70

 onmouseover="gutterOver(70)"

><td class="source">// executed.  Therefore, you should write your tests in such a way<br></td></tr
><tr
id=sl_svn704_71

 onmouseover="gutterOver(71)"

><td class="source">// that their results don&#39;t depend on their order.<br></td></tr
><tr
id=sl_svn704_72
...
><td class="source">TEST(FactorialTest, Negative) {<br></td></tr
><tr
id=sl_svn704_80

 onmouseover="gutterOver(80)"

><td class="source">  // This test is named &quot;Negative&quot;, and belongs to the &quot;FactorialTest&quot;<br></td></tr
><tr
id=sl_svn704_81

 onmouseover="gutterOver(81)"

><td class="source">  // test case.<br></td></tr
><tr
id=sl_svn704_82
...
><td class="source">  // EXPECT_EQ(expected, actual) is the same as<br></td></tr
><tr
id=sl_svn704_89
...
><td class="source">  //   EXPECT_TRUE((expected) == (actual))<br></td></tr
><tr
id=sl_svn704_91
...
><td class="source">  // except that it will print both the expected value and the actual<br></td></tr
><tr
id=sl_svn704_93

 onmouseover="gutterOver(93)"

><td class="source">  // value when the assertion fails.  This is very helpful for<br></td></tr
><tr
id=sl_svn704_94

 onmouseover="gutterOver(94)"

><td class="source">  // debugging.  Therefore in this case EXPECT_EQ is preferred.<br></td></tr
><tr
id=sl_svn704_95
...
><td class="source">  // On the other hand, EXPECT_TRUE accepts any Boolean expression,<br></td></tr
><tr
id=sl_svn704_97

 onmouseover="gutterOver(97)"

><td class="source">  // and is thus more general.<br></td></tr
><tr
id=sl_svn704_98
...
><td class="source">TEST(FactorialTest, Zero) {<br></td></tr
><tr
id=sl_svn704_104
...
><td class="source">TEST(FactorialTest, Positive) {<br></td></tr
><tr
id=sl_svn704_109
...
><td class="source">TEST(IsPrimeTest, Negative) {<br></td></tr
><tr
id=sl_svn704_120

 onmouseover="gutterOver(120)"

><td class="source">  // This test belongs to the IsPrimeTest test case.<br></td></tr
><tr
id=sl_svn704_121
...
><td class="source">TEST(IsPrimeTest, Trivial) {<br></td></tr
><tr
id=sl_svn704_129
...
><td class="source">TEST(IsPrimeTest, Positive) {<br></td></tr
><tr
id=sl_svn704_137
...
><td class="source">// Step 3. Call RUN_ALL_TESTS() in main().<br></td></tr
><tr
id=sl_svn704_144
...
><td class="source">// We do this by linking in src/gtest_main.cc file, which consists of<br></td></tr
><tr
id=sl_svn704_146

 onmouseover="gutterOver(146)"

><td class="source">// a main() function which calls RUN_ALL_TESTS() for us.<br></td></tr
><tr
id=sl_svn704_147
...
><td class="source">// This runs all the tests you&#39;ve defined, prints the result, and<br></td></tr
><tr
id=sl_svn704_149

 onmouseover="gutterOver(149)"

><td class="source">// returns 0 if successful, or 1 otherwise.<br></td></tr
><tr
id=sl_svn704_150
...
><td class="source">// Did you notice that we didn&#39;t register the tests?  The<br></td></tr
><tr
id=sl_svn704_152

 onmouseover="gutterOver(152)"

><td class="source">// RUN_ALL_TESTS() macro magically knows about all the tests we<br></td></tr
><tr
id=sl_svn704_153

 onmouseover="gutterOver(153)"

><td class="source">// defined.  Isn&#39;t this convenient?<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 by vladlosev
 on Nov 4, 2011
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=607&amp;format=side&amp;path=/trunk/samples/sample1_unittest.cc&amp;old_path=/trunk/samples/sample1_unittest.cc&amp;old=482">Diff</a>
 </div>
...
Style Guide (by Greg Miller).</pre>
 ...
 var selected_path = '/trunk/samples/sample1_unittest.cc';
 ...
 by zhanyong.wan
 on Sep 13, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=482&amp;format=side&amp;path=/trunk/samples/sample1_unittest.cc&amp;old_path=/trunk/samples/sample1_unittest.cc&amp;old=40">Diff</a>
 <br>
...
instead of system headers.
 ...
 by shiqian
 on Jul 3, 2008
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=40&amp;format=side&amp;path=/trunk/samples/sample1_unittest.cc&amp;old_path=/trunk/samples/sample1_unittest.cc&amp;old=">Diff</a>
 <br>
 ...
 <a href="/p/googletest/source/list?path=/trunk/samples/sample1_unittest.cc&start=607">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//googletest.googlecode.com/svn/trunk/samples/sample1_unittest.cc">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn704': '/trunk/samples/sample1_unittest.cc'}
 codereviews = CR_controller.setup(
 {"projectName": "googletest", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "projectHomeUrl": "/p/googletest", "profileUrl": "/u/116848778305603003776/", "relativeBaseUrl": "", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "token": "ABZ6GAf49KvGwkRi-uOHfA6jzzWIhsByPg:1421292889673", "domainName": null, "assetHostPath": "http://www.gstatic.com/codesite/ph"}, '', 'svn704', paths,
