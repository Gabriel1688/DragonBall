...
<head>
 ...
 var codesite_token = "ABZ6GAeyr-73XC4msNIvL8DzwZ07lOwecQ:1421292879392";
 
 
 var CS_env = {"relativeBaseUrl": "", "assetVersionPath": "http://www.gstatic.com/codesite/ph/18133036155640238800", "domainName": null, "assetHostPath": "http://www.gstatic.com/codesite/ph", "projectName": "googletest", "loggedInUserEmail": "Gabriel.wang5@gmail.com", "token": "ABZ6GAeyr-73XC4msNIvL8DzwZ07lOwecQ:1421292879392", "projectHomeUrl": "/p/googletest", "profileUrl": "/u/116848778305603003776/"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgoogletest%2Fsource%2Fbrowse%2Ftrunk%2Fsamples%2Fsample10_unittest.cc" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/googletest/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/googletest/source/browse/trunk/samples/">samples</a><span class="sp">/&nbsp;</span>sample10_unittest.cc</span>
 ...
 <a href="/p/googletest/source/browse/trunk/samples/sample10_unittest.cc?edit=1"
 ...
 <li><a href="/p/googletest/source/browse/trunk/samples/sample10_unittest.cc?r=482" title="Previous">&lsaquo;r482</a></li>
...
><td class="source">// a primitive leak checker.<br></td></tr
><tr
id=sl_svn704_33
...
><td class="source">// We will track memory used by this class.<br></td></tr
><tr
id=sl_svn704_51

 onmouseover="gutterOver(51)"

><td class="source">class Water {<br></td></tr
><tr
id=sl_svn704_52
...
><td class="source">  // Normal Water declarations go here.<br></td></tr
><tr
id=sl_svn704_54
...
><td class="source">  // operator new and operator delete help us control water allocation.<br></td></tr
><tr
id=sl_svn704_56

 onmouseover="gutterOver(56)"

><td class="source">  void* operator new(size_t allocation_size) {<br></td></tr
><tr
id=sl_svn704_57

 onmouseover="gutterOver(57)"

><td class="source">    allocated_++;<br></td></tr
><tr
id=sl_svn704_58

 onmouseover="gutterOver(58)"

><td class="source">    return malloc(allocation_size);<br></td></tr
><tr
id=sl_svn704_59
...
><td class="source">  void operator delete(void* block, size_t /* allocation_size */) {<br></td></tr
><tr
id=sl_svn704_62
...
><td class="source">  static int allocated() { return allocated_; }<br></td></tr
><tr
id=sl_svn704_67
...
><td class="source">  static int allocated_;<br></td></tr
><tr
id=sl_svn704_70
...
><td class="source">int Water::allocated_ = 0;<br></td></tr
><tr
id=sl_svn704_73
...
><td class="source">// This event listener monitors how many Water objects are created and<br></td></tr
><tr
id=sl_svn704_75

 onmouseover="gutterOver(75)"

><td class="source">// destroyed by each test, and reports a failure if a test leaks some Water<br></td></tr
><tr
id=sl_svn704_76

 onmouseover="gutterOver(76)"

><td class="source">// objects. It does this by comparing the number of live Water objects at<br></td></tr
><tr
id=sl_svn704_77

 onmouseover="gutterOver(77)"

><td class="source">// the beginning of a test and at the end of a test.<br></td></tr
><tr
id=sl_svn704_78

 onmouseover="gutterOver(78)"

><td class="source">class LeakChecker : public EmptyTestEventListener {<br></td></tr
><tr
id=sl_svn704_79
...
><td class="source">    initially_allocated_ = Water::allocated();<br></td></tr
><tr
id=sl_svn704_83
...
><td class="source">    int difference = Water::allocated() - initially_allocated_;<br></td></tr
><tr
id=sl_svn704_88
...
><td class="source">    // You can generate a failure in any event handler except<br></td></tr
><tr
id=sl_svn704_90

 onmouseover="gutterOver(90)"

><td class="source">    // OnTestPartResult. Just use an appropriate Google Test assertion to do<br></td></tr
><tr
id=sl_svn704_91
...
><td class="source">    EXPECT_LE(difference, 0) &lt;&lt; &quot;Leaked &quot; &lt;&lt; difference &lt;&lt; &quot; unit(s) of Water!&quot;;<br></td></tr
><tr
id=sl_svn704_93
...
><td class="source">  int initially_allocated_;<br></td></tr
><tr
id=sl_svn704_96
...
><td class="source">TEST(ListenersTest, DoesNotLeak) {<br></td></tr
><tr
id=sl_svn704_99

 onmouseover="gutterOver(99)"

><td class="source">  Water* water = new Water;<br></td></tr
><tr
id=sl_svn704_100

 onmouseover="gutterOver(100)"

><td class="source">  delete water;<br></td></tr
><tr
id=sl_svn704_101
...
><td class="source">// This should fail when the --check_for_leaks command line flag is<br></td></tr
><tr
id=sl_svn704_104

 onmouseover="gutterOver(104)"

><td class="source">// specified.<br></td></tr
><tr
id=sl_svn704_105

 onmouseover="gutterOver(105)"

><td class="source">TEST(ListenersTest, LeaksWater) {<br></td></tr
><tr
id=sl_svn704_106
...
><td class="source">  EXPECT_TRUE(water != NULL);<br></td></tr
><tr
id=sl_svn704_108
...
><td class="source">  bool check_for_leaks = false;<br></td></tr
><tr
id=sl_svn704_116

 onmouseover="gutterOver(116)"

><td class="source">  if (argc &gt; 1 &amp;&amp; strcmp(argv[1], &quot;--check_for_leaks&quot;) == 0 )<br></td></tr
><tr
id=sl_svn704_117

 onmouseover="gutterOver(117)"

><td class="source">    check_for_leaks = true;<br></td></tr
><tr
id=sl_svn704_118
...
><td class="source">    printf(&quot;%s\n&quot;, &quot;Run this program with --check_for_leaks to enable &quot;<br></td></tr
><tr
id=sl_svn704_120

 onmouseover="gutterOver(120)"

><td class="source">           &quot;custom leak checking in the tests.&quot;);<br></td></tr
><tr
id=sl_svn704_121
...
><td class="source">  // If we are given the --check_for_leaks command line flag, installs the<br></td></tr
><tr
id=sl_svn704_123

 onmouseover="gutterOver(123)"

><td class="source">  // leak checker.<br></td></tr
><tr
id=sl_svn704_124

 onmouseover="gutterOver(124)"

><td class="source">  if (check_for_leaks) {<br></td></tr
><tr
id=sl_svn704_125

 onmouseover="gutterOver(125)"

><td class="source">    TestEventListeners&amp; listeners = UnitTest::GetInstance()-&gt;listeners();<br></td></tr
><tr
id=sl_svn704_126
...
><td class="source">    // Adds the leak checker to the end of the test event listener list,<br></td></tr
><tr
id=sl_svn704_128

 onmouseover="gutterOver(128)"

><td class="source">    // after the default text output printer and the default XML report<br></td></tr
><tr
id=sl_svn704_129
...
><td class="source">    // The order is important - it ensures that failures generated in the<br></td></tr
><tr
id=sl_svn704_132

 onmouseover="gutterOver(132)"

><td class="source">    // leak checker&#39;s OnTestEnd() method are processed by the text and XML<br></td></tr
><tr
id=sl_svn704_133

 onmouseover="gutterOver(133)"

><td class="source">    // printers *before* their OnTestEnd() methods are called, such that<br></td></tr
><tr
id=sl_svn704_134

 onmouseover="gutterOver(134)"

><td class="source">    // they are attributed to the right test. Remember that a listener<br></td></tr
><tr
id=sl_svn704_135

 onmouseover="gutterOver(135)"

><td class="source">    // receives an OnXyzStart event *after* listeners preceding it in the<br></td></tr
><tr
id=sl_svn704_136

 onmouseover="gutterOver(136)"

><td class="source">    // list received that event, and receives an OnXyzEnd event *before*<br></td></tr
><tr
id=sl_svn704_137

 onmouseover="gutterOver(137)"

><td class="source">    // listeners preceding it.<br></td></tr
><tr
id=sl_svn704_138
...
><td class="source">    // We don&#39;t need to worry about deleting the new listener later, as<br></td></tr
><tr
id=sl_svn704_140

 onmouseover="gutterOver(140)"

><td class="source">    // Google Test will do it.<br></td></tr
><tr
id=sl_svn704_141

 onmouseover="gutterOver(141)"

><td class="source">    listeners.Append(new LeakChecker);<br></td></tr
><tr
id=sl_svn704_142
...
><td class="source">  return RUN_ALL_TESTS();<br></td></tr
><tr
id=sl_svn704_144
...
<script type="text/javascript">
 ...
 by vladlosev
 on Nov 4, 2011
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=607&amp;format=side&amp;path=/trunk/samples/sample10_unittest.cc&amp;old_path=/trunk/samples/sample10_unittest.cc&amp;old=482">Diff</a>
 </div>
...
Style Guide (by Greg Miller).</pre>
 ...
 var selected_path = '/trunk/samples/sample10_unittest.cc';
 ...
 by zhanyong.wan
 on Sep 13, 2010
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=482&amp;format=side&amp;path=/trunk/samples/sample10_unittest.cc&amp;old_path=/trunk/samples/sample10_unittest.cc&amp;old=359">Diff</a>
 <br>
...
instead of system headers.
 ...
 by zhanyong.wan
 on Dec 29, 2009
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=359&amp;format=side&amp;path=/trunk/samples/sample10_unittest.cc&amp;old_path=/trunk/samples/sample10_unittest.cc&amp;old=321">Diff</a>
 <br>
...
without warnings on Windows.
 ...
 by zhanyong.wan
 on Sep 30, 2009
 &nbsp; <a href="/p/googletest/source/diff?spec=svn704&r=321&amp;format=side&amp;path=/trunk/samples/sample10_unittest.cc&amp;old_path=/trunk/samples/sample10_unittest.cc&amp;old=320">Diff</a>
 <br>
...
...</pre>
 ...
 <a href="/p/googletest/source/list?path=/trunk/samples/sample10_unittest.cc&start=607">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//googletest.googlecode.com/svn/trunk/samples/sample10_unittest.cc">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn704': '/trunk/samples/sample10_unittest.cc'}
